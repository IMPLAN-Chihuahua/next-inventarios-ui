...
<TextField label="Número de inventario" value={editData.numeroInventario} onChange={(e) => setEditData({ ...editData, numeroInventario: inventoryFormat(e.target.value) })} sx={drawerFieldStyles} /><TextField label="Número de serie" value={editData.noSerie} onChange={(e) => setEditData({ ...editData, noSerie: sanitizeSafeText(e.target.value) })} sx={drawerFieldStyles} />
<TextField label="Descripción" value={editData.descripcion} onChange={(e) => setEditData({ ...editData, descripcion: sanitizeSafeText(e.target.value) })} sx={{ ...drawerFieldStyles, gridColumn: { sm: "1/-1" } }} /><TextField label="Marca" value={editData.marca} onChange={(e) => setEditData({ ...editData, marca: sanitizeSafeText(e.target.value) })} sx={drawerFieldStyles} /><TextField label="Modelo" value={editData.modelo} onChange={(e) => setEditData({ ...editData, modelo: sanitizeSafeText(e.target.value) })} sx={drawerFieldStyles} />
...
<Autocomplete freeSolo options={LOCALIZACIONES} value={editData.localizacion} onChange={(_, value) => setEditData({ ...editData, localizacion: sanitizeSafeText(value || "") })} onInputChange={(_, value) => setEditData((current) => ({ ...current, localizacion: sanitizeSafeText(value) }))} renderInput={(params) => <TextField {...params} label="Localización" sx={drawerFieldStyles} />} /><TextField type="number" label="Costo" value={editData.costo} onChange={(e) => setEditData({ ...editData, costo: e.target.value })} sx={drawerFieldStyles} /><TextField label="Datos de factura" value={editData.datosFactura} onChange={(e) => setEditData({ ...editData, datosFactura: sanitizeSafeText(e.target.value) })} sx={drawerFieldStyles} />
